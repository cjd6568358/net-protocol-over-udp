export default {
  ...
  netmaskFromIP: function (ip) {
    ...
    if (typeof ip === "string") ip = this.parseIp(ip);
  ...
  CIDRFromNetmask: function (net) {
    if (typeof net === "string") net = this.parseIp(net);
  ...
  netmaskFromRange: function (ip1, ip2) {
    if (typeof ip1 === "string") ip1 = this.parseIp(ip1);

    if (typeof ip2 === "string") ip2 = this.parseIp(ip2);
